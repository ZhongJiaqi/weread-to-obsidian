...
> 给同时重度使用微信读书和 Obsidian 的读书人的笔记同步 CLI，解决划线和想法困在 App 里、想温习时翻不回来的问题。

## 为什么做这个

好书从来不是读一遍就完的——真正的收获在重读。读的时候遇到特别有感悟的地方，随手划线、写下当时的想法，这些顿悟才是一本书最值钱的部分。

但书一多问题就来了：在微信读书里攒下 33 本书、6500+ 条划线和想法之后，想温习某个观点，只记得「在某本书里见过」——一本一千多页的书要从头翻起，根本想不起它落在哪一页。

所以做了这个：基于官方 weread-skills 的单文件 Python CLI，一条命令把一本书的全部划线、想法按章节收成一份完整的读书笔记，落进 Obsidian——复习、温故、回溯都在自己的知识库里完成，可检索、可双链引用，随时一键跳回 App 原文。
...
用这个工具已沉淀 12 本已读完书籍的笔记，这是其中几本：

| 书名 | 作者 | 划线 | 想法 |
|---|---|---|---|
| [思考，快与慢（第二版）](notes/思考快与慢-读书笔记.md) | 丹尼尔·卡尼曼 | 1028 | 421 |
| 影响力（全新升级版） | 罗伯特·西奥迪尼 | 1343 | 240 |
| 哈佛经典谈判术：你一开口就赢麻了 | 迪帕克·马尔霍特拉 / 马克斯·巴泽曼 | 922 | 281 |
...
> 《思考，快与慢》读完后另做了一份提炼：[38 个概念的读书笔记](notes/思考快与慢-读书笔记.md)。

**在读**

| 书名 | 作者 | 划线 | 想法 |
|---|---|---|---|
| 摩根写给儿子的32封信 | 摩根 | 129 | 27 |
| 自卑与超越 | 阿尔弗雷德·阿德勒 | 28 | 4 |
| 有限与无限的游戏：一个哲学家眼中的竞技世界 | 詹姆斯·卡斯 | 82 | 13 |
